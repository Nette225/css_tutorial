# Path2Tech CSS Tutorial

This repository will help guide you on getting familiar with using CSS to style your applications
...
2. After the project has been started you can edit the `index.html`, and `styles.css` code files to be able to change the output of your web application.
